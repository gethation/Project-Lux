...
def test_full_poc_replay_matches_reference_summary(tmp_path) -> None:
    ...
    # 2026-05-15, permanently dropping the 05-08..05-15 CCF opens. The trade set is
    # unchanged (66 trades, same directions/exits); 4 entries in that gap now fall
    # back to ccf_close_filled for their entry open, shifting gross PnL by ~-3,977.
    ...
    assert summary["ccf_forward_filled_session_minutes"] == 6328
