...
SQLITE_SCHEMA = r"""
            ...
            CREATE TABLE IF NOT EXISTS positions (
                ...
                state TEXT NOT NULL,
                direction TEXT,
                umc_units REAL NOT NULL,
                ccf_units REAL NOT NULL,
                ccf_contracts INTEGER NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS bars (
                ...
                ccf_close_filled REAL NOT NULL,
                umc_twd_fair REAL NOT NULL,
                ccf_was_filled INTEGER NOT NULL DEFAULT 0,
                ccf_entry_price REAL,
                umc_entry_twd_fair REAL,
                ccf_entry_open_was_filled INTEGER NOT NULL DEFAULT 0,
                ccf_symbol TEXT,
                ccf_expiry TEXT,
                contract_policy_state TEXT,
                short_spread REAL,
            ...
            CREATE TABLE IF NOT EXISTS trades (
                ...
                entry_umc_twd_fair REAL NOT NULL,
                entry_ccf_close REAL NOT NULL,
                umc_units REAL NOT NULL,
                ccf_units REAL NOT NULL,
                ccf_contracts INTEGER NOT NULL,
                raw_ccf_contracts REAL NOT NULL,
                leg_notional_twd REAL NOT NULL,
                actual_leg_notional_twd REAL NOT NULL,
                ccf_contract_multiplier REAL NOT NULL,
                entry_umc_fee_twd REAL NOT NULL,
                entry_ccf_fee_twd REAL NOT NULL,
                entry_ccf_tax_twd REAL NOT NULL,
                ...
                exit_umc_twd_fair REAL NOT NULL,
                exit_ccf_close REAL NOT NULL,
                umc_pnl REAL NOT NULL,
                ccf_pnl REAL NOT NULL,
                gross_pnl_twd REAL NOT NULL,
                exit_umc_fee_twd REAL NOT NULL,
                exit_ccf_fee_twd REAL NOT NULL,
                exit_ccf_tax_twd REAL NOT NULL,
                exit_fee_twd REAL NOT NULL,
                umc_fee_twd REAL NOT NULL,
                ccf_fee_twd REAL NOT NULL,
                ccf_tax_twd REAL NOT NULL,
...
def ensure_live_metadata_columns(connection: sqlite3.Connection) -> None:
    for table in ("orders", "fills", "bars", "trades", "warmup_bars"):
        ensure_column(connection, table, "ccf_symbol", "TEXT")
        ensure_column(connection, table, "ccf_expiry", "TEXT")
    ...
    ensure_column(connection, "warmup_bars", "ccf_was_filled", "INTEGER NOT NULL DEFAULT 0")
